...
# 定义输入文件夹和输出文件夹
input_folder = r'/home/zz/Downloads/images集合/images'  # 替换为实际的XML文件夹路径
output_folder = r'/home/zz/Downloads/ultralytics-8.3.169/data/labels'  # 替换为实际的输出TXT文件夹路径
