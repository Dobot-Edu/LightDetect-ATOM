...
src_right = read_2d_points_from_file('camPosT_1.txt')  # green → 右手
    ...
    while True:
        ...
        if state == STATE_DETECTING:
            ...
            # 情况2：正在延迟中
                ...
                # 更新最后有效位置
                if current_duration == 10 and green_detected and yellow_detected:
                ...
                elif current_duration == 5 and green_detected:
