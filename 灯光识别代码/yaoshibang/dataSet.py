# 数据集制作第二步，数据集划分，需要划分为训练集、验证集和测试集
...
if __name__ == '__main__':
    file_path = r"/home/zz/Downloads/ultralytics-8.3.169/data/JPEGImages"  # 图片文件夹
    label_path = r'/home/zz/Downloads/ultralytics-8.3.169/data/labels'  # 标签文件夹
    new_file_path = r"/home/zz/Downloads/ultralytics-8.3.169/data/VOCdevkit"  # 新数据存放位置
